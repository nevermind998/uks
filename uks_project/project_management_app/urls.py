...
urlpatterns = [
    ...
    path('issues/<str:name>/name', views.issues_by_name, name='issues_by_name'),
    path('issues/<str:name>/name/<str:status>/status', views.issues_by_name_status, name='issues_by_name_status'),
